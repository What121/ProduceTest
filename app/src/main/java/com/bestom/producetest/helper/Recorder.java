package com.bestom.producetest.helper;
...
public class Recorder implements MediaPlayer.OnCompletionListener,
    ...
    public static final String DATA_PATH = "/data/data/com.bestom.producetest/";
    private static final String TEST_FILE_PATH = DATA_PATH + "test";
