...
public class ExeCommand {
    ...
    public ExeCommand run(String command, final int maxTime) {
        Log.i(TAG, "run command:" + command + ",maxtime:" + maxTime);
        ...
        try {
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            Log.i(TAG, "exitValue Stream over" + ret);
            ...
            if (bSynchronous) {
                Log.i(TAG, "run is go to end");
                t3.join();
                Log.i(TAG, "run is end");
            }
        } catch (Exception e) {
            Log.i(TAG, "run command process exception:" + e.toString());
        }
        return this;
    }
}
