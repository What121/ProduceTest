...
public class productBean {
    ...
    public productBean() {
        new productBean( firmVersion,  cpu,  ddr,  sn,  emmc,  tp,  wifi,  bt,  sd,  usb,  leftsound,  rightsound,  micro,  powerkey,  vpkey,  vdkey,  rgb,  gsensor,  lightsensor,  nfc,  nfclight,  frontcamera,  backcamera ,gpio, network,time);
    }

    private productBean(String firmVersion, String cpu, String ddr, String sn, String emmc, int tp, int wifi, int bt, int sd, int usb, int leftsound, int rightsound, int micro, int powerkey, int vpkey, int vdkey, int rgb, int gsensor, int lightsensor, int nfc, int nfclight, int frontcamera, int backcamera , int gpio, int network,String time) {
